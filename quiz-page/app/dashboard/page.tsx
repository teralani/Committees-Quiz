...
/**
 * Persist editorQuestions to server-side pageText.json via an API route.
 * Only called when "Save to pageText.json" is pressed.
 */
  ...
  return (
    <div className={`${montserrat.variable} font-sans min-h-screen bg-slate-50`}>
      <nav className="h-20 md:h-16 flex justify-center items-center w-full bg-primary text-white">
        ...
        <h1 className="text-2xl font-bold">KINGMUN 2026 — Quiz Editor</h1>
      </nav>
